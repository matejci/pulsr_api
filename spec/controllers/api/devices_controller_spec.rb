...
RSpec.describe Api::DevicesController, type: :controller, skip: true do
  ...
  # Api::DevicesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested api_device as @api_device" do
      ...
      expect(assigns(:api_device)).to eq(device)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new api_device as @api_device" do
      ...
      expect(assigns(:api_device)).to be_a_new(Device)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created api_device as @api_device" do
        post :create, {:api_device => valid_attributes}, valid_session
        expect(assigns(:api_device)).to be_a(Device)
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_device" do
        device = Device.create! valid_attributes
        put :update, {:id => device.to_param, :api_device => new_attributes}, valid_session
        device.reload
      ...
      it "assigns the requested api_device as @api_device" do
        device = Device.create! valid_attributes
        put :update, {:id => device.to_param, :api_device => valid_attributes}, valid_session
        expect(assigns(:api_device)).to eq(device)
      end
    ...
    context "with invalid params" do
      it "assigns the api_device as @api_device" do
        device = Device.create! valid_attributes
        put :update, {:id => device.to_param, :api_device => invalid_attributes}, valid_session
        expect(assigns(:api_device)).to eq(device)
      end
